...
namespace DawsonSoft.Salesloft.Api.Core.Model
{
    ...
    /// SharingSettings
    /// </summary>
    [DataContract(Name = "SharingSettings")]
    public partial class SharingSettings : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SharingSettings" /> class.
        /// </summary>
        /// <param name="teamCadence">teamCadence.</param>
        public SharingSettings(bool? teamCadence = default(bool?))
        {
